...
} && std::move_constructible<HandlerType> && !std::copy_constructible<HandlerType> && std::is_nothrow_move_assignable_v<HandlerType>;
...
public:
    ...
    BaseHandler(BaseHandler&& other) noexcept :formatter_(std::move(other.formatter_)) {}
